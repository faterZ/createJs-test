...
(lib.view2 = function(mode,startPosition,loop) {
	...
	this.frame_116 = function() {
		...
		this.addEventListener("click",function(){
				if(model) model.dispatchEvent("completeClick2");
		})
	}
	...
	this.instance_6.setTransform(320.1,317.7,1,1,0,0,0,170,197);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).wait(13).to({_off:true},158).wait(30));
	...
	// 图层 1
	this.btn_1 = new lib.mc1();
	this.btn_1.setTransform(336.6,409.4);

	this.timeline.addTween(cjs.Tween.get(this.btn_1).to({_off:true},1).wait(201));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-38.4,-193.6,788.5,1439.3);
